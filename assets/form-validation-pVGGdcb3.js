...
`},Z=L("p",null,[y("Use "),L("code",null,"Rules"),y(" prop to validate the input.")],-1),Pe={__name:"form-validation",setup(T){return(w,h)=>{const F=K,n=z,m=H,c=G;return g(),P(A,null,{default:o(()=>[l(i,{cols:"12"},{default:o(()=>[l(n,{title:"Simple Form Validation",code:Q},{default:o(()=>[Z,l(F)]),_:1},8,["code"])]),_:1}),l(i,{cols:"12"},{default:o(()=>[l(n,{title:"Validating Multiple Rules",code:W},{default:o(()=>[l(m)]),_:1},8,["code"])]),_:1}),l(i,{cols:"12"},{default:o(()=>[l(n,{title:"Validation Types",code:X},{default:o(()=>[l(c)]),_:1},8,["code"])]),_:1})]),_:1})}}};export{Pe as default};
