...
const handleConfirm = async (confirmed) => {
  if (confirmed) {
    try {
      const res = await $api('/addIbCommissionPlan', {
        method: 'POST',
        body: {
...
<template>
  ...
  >
    ...
    <VCard class="pa-6 pa-sm-10">
      ...
      >
        ...
        <div>
          <div class="d-flex align-center app-logo" style="font-weight: bold;">
      ...
      <VForm @submit.prevent="() => {}">
        ...
        <VRow class="ms-3 mb-3">
          <table>
            ...
            <tr class="me-3">
              <th><br>L1|D1
                <VTextField v-model="headerL1D1" class="w-"/>
              </th>
            </tr>
            <tr class="me-3">
              <th><br>L2|D1
        ...
        <VRow>
          <VCol cols="6">
            <VBtn class="ms-3" color="primary" @click="handleAddDetailsSubmit">
              Submit
            </VBtn>
          </VCol>
        </VRow>
  ...
  <ConfirmDialog v-model:isDialogVisible="isConfirmDialogVisible" @confirm="handleConfirm"
                 confirmation-question="Are you want to add IB Plan Details?" cancel-title="Cancelled"
