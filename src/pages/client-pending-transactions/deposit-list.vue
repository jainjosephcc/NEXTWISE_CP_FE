...
const selectedDepositStatus = ref("0")
...
watch([page, itemsPerPage, selectedMTStatus, mt5SearchQuery, selectedFromDate, selectedToDate, selectedManager, selectedDocStatus, selectedDepositStatus, selectedCurrency, selectedPaymentMenthod, selectedIBStatus, searchQuery, sortBy, orderBy], () => {
  fetchDepositList()
